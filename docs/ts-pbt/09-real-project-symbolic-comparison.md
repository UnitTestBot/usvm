...
> **Статус: интеграционный smoke-пилот, не representative benchmark.** Три
> вручную выбранных метода и 14 ветвей слишком малы для ранжирования движков.
> Широкая кампания на 612 ветвях и аналитические выводы находятся в
