...
> **Статус: интеграционный smoke-пилот, не representative benchmark.** Результат
> `14/14` проверяет exchange/replay plumbing, но ничего не доказывает об
> эффективности инструментов. Сравнение на 130 branch-bearing методах и 612
> ветвях находится в `11-representative-open-source-campaign.md`.
