...
//Tool name: Usvm Results: [497]
//Tool name: Semgrep Results: [327]
//Original file name: BenchmarkTest00855
//Original file CWE's: [327]  
//Mutation info: Insert template from templates/cycles/while.tmt with index 0 
//Program:
/**
...
public class BenchmarkTest00855197 extends HttpServlet {
...
while (!param.valueOf(serialVersionUID).equals(param.concat(param)) || param.equals(bar.replaceFirst(bar,param))) {
    bar = request.getAuthType();
}
}
