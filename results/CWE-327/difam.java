...
//Original file name: BenchmarkTest02549
//Original file CWE's: [327]  
//Mutation info: Insert template from templates/cycles/for.tmt with index 0 
//Program:
/**
...
public class BenchmarkTest02549694 extends HttpServlet {
...
for (int i = 0; i < 0; i++) {
 bar = response.encodeRedirectUrl(paramval).replace('/', '.');
}
