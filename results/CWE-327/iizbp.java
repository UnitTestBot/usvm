...
//Original file name: BenchmarkTest00258
...
public class BenchmarkTest00258341 extends HttpServlet {
        ...
        try {
            ...
            fw.write(
                    "secret_value="
                            ...
                            + "\n");
int index = 14032;
while (param.valueOf(inputParam).equals("zvpmf") && index < -5570) {
    bar = response.getHeader(bar);
    index += -2837;
}
fw.close();
            response.getWriter()
