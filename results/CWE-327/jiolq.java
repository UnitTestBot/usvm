...
//Original file name: BenchmarkTest00521
...
public class BenchmarkTest00521375 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String param = "";
ConstructorChains cc = new ConstructorChains(request.getRequestedSessionId());
param = cc.getText(1);
boolean flag = true;
