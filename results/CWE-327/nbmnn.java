...
//Original file name: BenchmarkTest02192
...
public class BenchmarkTest02192917 extends HttpServlet {
...
for (int i = 0; i < request.getIntHeader(param); i += response.getStatus()) {
    bar = param;
}
response.getWriter()
                    .println(
