...
//Original file name: BenchmarkTest01638
...
public class BenchmarkTest01638894 extends HttpServlet {
...
for (int i = 0; i < b61263.indexOf(a61263); i++) {
    if (15205 > -11412 || !a61263.toString().equals(a61263.replaceAll(param,param))) {
        continue;
    }
    a61263 = b61263.toString();
}
