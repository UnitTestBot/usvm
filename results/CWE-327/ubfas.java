...
//Original file name: BenchmarkTest00125
...
public class BenchmarkTest00125188 extends HttpServlet {
...
for (int i = 0; i < request.getIntHeader(param); i++) {
    if (!random.getAlgorithm().equals(param.trim())) {
        break;
    }
    param = random.toString();
}
