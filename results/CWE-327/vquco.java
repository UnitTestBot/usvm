//Analysis results:
//Tool name: SpotBugs Results: [327, 0, 22, 329, 79]
//Tool name: CodeQL Results: [209, 79, 327]
//Tool name: SonarQube Results: []
//Tool name: Usvm Results: [497, 113, 99, 501]
//Tool name: Semgrep Results: [614, 327]
//Original file name: BenchmarkTest01822
...
public class BenchmarkTest0182281 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //	    };
CollectionHolder ch = new CollectionHolder(request.getRemoteUser());
bar = ch.list.get(request.getIntHeader(bar));
