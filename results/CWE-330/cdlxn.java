...
public class BenchmarkTest00489760 extends HttpServlet {
...
ArrayHolder ah = new ArrayHolder(rememberMeKey);
testCaseNumber = ah.getValues()[user.lastIndexOf(cookieName)];
