...
//Tool name: Usvm Results: [501, 99, 113]
//Tool name: Semgrep Results: [330]
//Original file name: BenchmarkTest00161
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/pathSensitivity/loops.tmt with index 7 
//Program:
/**
...
public class BenchmarkTest00161879 extends HttpServlet {
            ...
            response.getWriter()
                    .println(
                            user
                                    ...
                                    + rememberMe.getValue()
                                    + "<br/>");
for (int i = rememberMe.getMaxAge(); i < cookieName.indexOf(bar); i++) {
    testCaseNumber = testCaseNumber.valueOf(value);
}
}
