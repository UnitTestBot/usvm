...
//Tool name: Usvm Results: [22, 73, 501, 99, 113]
//Tool name: Semgrep Results: [330]
//Original file name: BenchmarkTest00161
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/pathSensitivity/loops.tmt with index 9 
//Program:
/**
...
public class BenchmarkTest00161878 extends HttpServlet {
...
try (BufferedReader br = new BufferedReader(new FileReader(request.getMethod()))) {
    String line;
