...
//Tool name: Usvm Results: [99, 113, 501]
//Tool name: Semgrep Results: [330]
//Original file name: BenchmarkTest01518
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/pathSensitivity/complexIf.tmt with index 7 
//Program:
/**
...
public class BenchmarkTest01518302 extends HttpServlet {
...
if (response != null) {
    param = bar.valueOf(serialVersionUID);
}
