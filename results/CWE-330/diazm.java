...
//Mutation info: Insert template from templates/pathSensitivity/loops.tmt with index 6 
//Program:
/**
...
public class BenchmarkTest01183704 extends HttpServlet {
...
for (int i = 0; i < cookieName.indexOf(testCaseNumber); i += rememberMeKey.compareToIgnoreCase(bar)) {
    bar = user.toUpperCase();
}
} // end doPost
