...
public class BenchmarkTest01127816 extends HttpServlet {
...
for (int i = 0; i < param.indexOf(param); i++) {
    if (request.isUserInRole(param) == response.containsHeader(param) || request.getDateHeader(param) != serialVersionUID) {
        continue;
    }
