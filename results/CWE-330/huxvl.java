...
//Original file name: BenchmarkTest02419
...
public class BenchmarkTest0241995 extends HttpServlet {
...
Configurator conf = new Configurator(bar.compareTo(user), rememberMeKey);
fullClassName = conf.getConfigurationValue();
