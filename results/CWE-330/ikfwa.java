...
//Original file name: BenchmarkTest01603
...
public class BenchmarkTest01603143 extends HttpServlet {
...
for (int i = 0; i < request.getIntHeader(testCaseNumber); i++) {
    if ('t' >= 'k') {
        break;
    }
    cookieName = fullClassName.replaceAll(user,bar);
}
if (foundUser) {
