...
public class BenchmarkTest005630 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String user = "Ingrid";
ArrayHolder ah = new ArrayHolder(response.encodeUrl(rememberMeKey));
param = ah.getValues()[param.offsetByCodePoints(r,r)];
