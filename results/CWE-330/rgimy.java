...
//Original file name: BenchmarkTest00484
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/cycles/while.tmt with index 4 
//Program:
/**
...
public class BenchmarkTest00484884 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookies != null) {
int index = num;
while (index < fullClassName.indexOf(num,num)) {
    if (param.equals(cookieName.replaceFirst(user,testCaseNumber))) {
