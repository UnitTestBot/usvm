...
//Mutation info: Insert template from templates/pathSensitivity/loops.tmt with index 8 
//Program:
/**
...
public class BenchmarkTest01273227 extends HttpServlet {
...
for (int i = 0; i < fullClassName.trim().length(); i++) {
    char c = cookieName.trim().charAt(i);
    testCaseNumber = testCaseNumber + c;
}
