...
//Tool name: Usvm Results: [501, 113]
//Tool name: Semgrep Results: [330]
//Original file name: BenchmarkTest00489
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/pathSensitivity/complexIf.tmt with index 9 
//Program:
/**
...
public class BenchmarkTest00489459 extends HttpServlet {
...
if (Arrays.asList("rcojl", "bceew", "awhug", "lzmqg").contains(map)) {
    rememberMeKey = user;
}
