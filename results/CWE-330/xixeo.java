...
//Original file name: BenchmarkTest00234
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/cycles/for.tmt with index 12 
//Program:
/**
...
public class BenchmarkTest00234982 extends HttpServlet {
...
String bar = name.valueOf(serialVersionUID);
   	 for (int i = 0; i < 10; i++) {
   		 if (i < 9) {
       		 continue;
   		 }
