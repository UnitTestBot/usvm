...
public class BenchmarkTest00161871 extends HttpServlet {
...
ConstructorDelegation cd = new ConstructorDelegation(fullClassName.toLowerCase());
    fullClassName = cd.getC();
