...
//Original file name: BenchmarkTest00971
//Original file CWE's: [330]  
//Mutation info: Insert template from templates/cycles/while.tmt with index 3 
//Program:
/**
...
public class BenchmarkTest00971774 extends HttpServlet {
...
while (index < testCaseNumber.hashCode()) {
    bar = bar.toString();
    index++;
}
