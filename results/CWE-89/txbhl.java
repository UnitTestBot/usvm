...
//Original file name: BenchmarkTest01462
...
public class BenchmarkTest01462949 extends HttpServlet {
...
ArrayHolder ah = new ArrayHolder(request.getAuthType());
name = ah.getValues()[request.getIntHeader(param)];
