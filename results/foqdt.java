...
public class BenchmarkTest0003554 extends HttpServlet {
...
if (algorithm instanceof String) strInput = ((String) inputParam).getBytes();
...
if ((500 / 42) + i > 200) param = algorithm;
        else param = "This should never happen";
