...
public class BenchmarkTest0003588 extends HttpServlet {
...
if (name instanceof String) param = ((String) param);
...
if (algorithm instanceof String) input = ((String) param).getBytes();
