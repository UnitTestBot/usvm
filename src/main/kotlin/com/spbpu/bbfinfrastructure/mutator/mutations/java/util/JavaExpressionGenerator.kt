...
class JavaExpressionGenerator: ExpressionGenerator() {
    ...
    private fun Method.canBeInvokedWithScopeVariables(scope: List<ScopeComponent>): Boolean =
        parameters.isEmpty() ||
    ...
    private fun Method.constructMethodInvocation(scope: List<ScopeComponent>): String? {
