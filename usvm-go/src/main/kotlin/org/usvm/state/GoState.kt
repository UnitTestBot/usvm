...
class GoState(
    ...
    fun isPointer(pointer: UHeapRef): UExpr<UBoolSort> {
        ...
        return ctx.mkEq(field, ctx.mkBv(50541, ctx.bv32Sort))
    }
    ...
    fun mkPointer(type: GoType, value: UExpr<out USort>): UConcreteHeapRef {
        return mkTuple(type, value, ctx.mkBv(50541, ctx.bv32Sort))
    }
