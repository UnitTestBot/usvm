 ...
 */
fun JcState.throwExceptionWithoutStackFrameDrop(address: UHeapRef, type: JcType, expected: Boolean) {
    methodResult = JcMethodResult.JcException(address, type, callStack.stackTrace(lastStmt), expected)
}
