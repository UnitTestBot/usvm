...
import org.usvm.examples.casts.ColoredPoint;
import org.usvm.examples.casts.Point;
...
public class ArrayOfArrays {
    ...
    public int[][] simpleExample(int[][] matrix) {
        assume(matrix != null && matrix.length > 2);
        assume(matrix[0] != null && matrix[1] != null && matrix[2] != null);
