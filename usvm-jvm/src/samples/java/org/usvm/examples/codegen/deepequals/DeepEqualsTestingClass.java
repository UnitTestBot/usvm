package org.usvm.examples.codegen.deepequals;

import static org.usvm.api.mock.UMockKt.assume;
import org.usvm.examples.codegen.deepequals.inner.GraphNode;
import org.usvm.examples.codegen.deepequals.inner.Node;
...
public class DeepEqualsTestingClass {
    ...
    GraphNode returnQuadrilateralFromNode(GraphNode first) {
        assume(first != null);
        assume(first.nextNodes != null);
        assume(first.nextNodes.isEmpty());
