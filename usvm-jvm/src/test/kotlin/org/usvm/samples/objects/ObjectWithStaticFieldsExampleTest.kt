...
//
//
//internal class ObjectWithStaticFieldsExampleTest : JavaMethodTestRunner() {
//    @Test
...
//            eq(4),
//            { _, o, _, _ -> o == null },
//            { _, o, _, _ -> o != null && o.x < 100 },
//            { _, o, _, _ -> o != null && o.x >= 100 && o.y < 150 },
//            { _, o, staticsAfter, r ->
...
//            eq(3),
//            { _, o, _, _ -> o == null },
//            { _, o, statics, _ -> o != null && statics.singleValue() as Int != 3 },
//            { _, o, statics, r -> o != null && statics.singleValue() as Int == 3 && r != null && r.x == 3 },
//        )
//    }
//
//    @Test
...
//            { _, n, _, r -> n < 0 && r == Double.NEGATIVE_INFINITY },
//            { _, statics, _ -> statics.singleValue() == null },
