...
sealed class PythonTypeDescription(name: Name) : TypeMetaDataWithName(name) {
    ...
    open fun getMemberByName(storage: PythonTypeHintsBuild, type: UtType, name: String): PythonDefinition? =
...
sealed class PythonCompositeTypeDescription(
    ...
    fun mro(storage: PythonTypeHintsBuild, type: UtType): List<UtType> {
        val compositeType = castToCompatibleTypeApi(type)
    ...
    override fun getMemberByName(storage: PythonTypeHintsBuild, type: UtType, name: String): PythonDefinition? {
