...
class SampleState(
    ...
    pathConstraints: UPathConstraints<SampleType, UContext<USizeSort>> = UPathConstraints(ctx),
    ...
    override fun clone(newConstraints: UPathConstraints<SampleType, UContext<USizeSort>>?): SampleState {
