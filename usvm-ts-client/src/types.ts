...
export const TargetDtoSchema = z.object({
  type: z.nativeEnum(TargetTypeDto).default(TargetTypeDto.INTERMEDIATE).describe('Target type'),
...
export type TargetTreeNodeDto = z.infer<typeof TargetTreeNodeDtoSchema>;
...
export const AnalysisConfigSchema = z.object({
    ...
    analysisMode: z.nativeEnum(AnalysisMode).default(AnalysisMode.PUBLIC_METHODS).describe('Analysis scope'),
    methodFilters: z.array(z.string()).default([]).describe('Filter methods by name patterns'),
    solverType: z.nativeEnum(SolverType).default(SolverType.YICES).describe('SMT solver to use'),
    ...
    executionMode: z.nativeEnum(ExecutionMode).default(ExecutionMode.SHADOW).describe('CLI execution mode'),
});
...
export const AnalysisReportSchema = z.object({
    ...
    analysisMode: z.nativeEnum(AnalysisMode).describe('Analysis mode used'),
    solverType: z.nativeEnum(SolverType).describe('SMT solver used'),
