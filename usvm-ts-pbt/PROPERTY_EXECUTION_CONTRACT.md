...
- USVM projection and search implementations consume the same manifest and mapping artifacts and must link to
  this contract when their dependent changes are integrated.
