...
import org.usvm.machine.call.TsMachineLocalUnknownCallModel
...
internal object TsArrayPopEtsIrModel : TsBuiltInUnknownCallModel, TsMachineLocalUnknownCallModel {
    ...
    private val model by lazy {
        ...
        val domainGuard = TsEtsIrUnknownCallModelDomainGuard { state, call, inputs ->
            with(state.ctx) {
    ...
    ): TsUnknownCallModel = model.materializeForMachine(materializedFiles)
}
