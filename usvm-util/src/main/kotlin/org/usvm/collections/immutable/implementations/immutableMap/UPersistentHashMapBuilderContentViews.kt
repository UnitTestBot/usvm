...
internal class PersistentHashMapBuilderEntries<K, V>(private val builder: UPersistentHashMapBuilder<K, V>)
...
internal class PersistentHashMapBuilderKeys<K, V>(private val builder: UPersistentHashMapBuilder<K, V>) : MutableSet<K>, AbstractMutableSet<K>() {
...
internal class PersistentHashMapBuilderValues<K, V>(private val builder: UPersistentHashMapBuilder<K, V>) : MutableCollection<V>, AbstractMutableCollection<V>() {
    override val size: Int
        get() = builder.size
