...
internal class PersistentOrderedMap<K, V>(
        ...
        internal val hashMap: UPersistentHashMap<K, LinkedValue<V>>
...
//            assert(nextLinks.previous == key)
    ...
    internal companion object {
        private val EMPTY = PersistentOrderedMap<Nothing, Nothing>(EndOfChain, EndOfChain, UPersistentHashMap.emptyOf())
        @Suppress("UNCHECKED_CAST")
